...
class TheMovieDBAppUITests: XCTestCase {
...
//    }
    func testFavoriteButton(){
        ...
        let theOutfitStaticText = XCUIApplication().staticTexts["The Outfit"]
        theOutfitStaticText.tap()
        theOutfitStaticText.tap()
        
    }
    func testImdbButton(){
        
        XCUIApplication().staticTexts["Benzer Filmler"].tap()
    ...
    func testsearchText(){
        ...
        let cancel = moviesNavigationBar.buttons["Cancel"]
